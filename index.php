...
<body>
    ...
    <div class="container">
        <div class="col">
            <textarea name="p7" id="p7" rows="4" cols="1000" oninput="limitarPalavras(this, 20)"></textarea>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col">
                <input type="text" id="p8" name="p8" pattern="[A-Za-zÀ-ú\s]+" title="Apenas letras são permitidas" required><br>
            </div>
        </div>
        <hr>
